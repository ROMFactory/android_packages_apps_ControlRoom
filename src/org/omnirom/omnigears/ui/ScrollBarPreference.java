...
public class ScrollBarPreference extends Preference
    ...
    public ScrollBarPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        ...
        if (progress > 0) {
            monitorBox.setText(String.valueOf(progress * 15) + "units");
        } else {
            monitorBox.setText(mContext.getResources().getString(R.string.animation_scroll_friction_default));
        }
