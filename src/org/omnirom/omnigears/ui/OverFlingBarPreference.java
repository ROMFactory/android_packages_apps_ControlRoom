...
public class OverFlingBarPreference extends Preference
    ...
    int defaultValue = ViewConfiguration.DEFAULT_OVERFLING_DISTANCE / 15;

    private OnPreferenceChangeListener changer;

    public OverFlingBarPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        ...
        if (progress > 0) {
            ...
            monitorBox.setText(mContext.getResources().getString(R.string.animation_overfling_distance_default));
        }
