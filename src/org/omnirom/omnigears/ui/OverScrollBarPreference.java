...
public class OverScrollBarPreference extends Preference
    ...
    int defaultValue = ViewConfiguration.DEFAULT_OVERSCROLL_DISTANCE;

    private OnPreferenceChangeListener changer;

    public OverScrollBarPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        ...
        if (progress > 0) {
            monitorBox.setText(String.valueOf(progress) + "px");
        } else {
            monitorBox.setText(mContext.getResources().getString(R.string.animation_overscroll_distance_default));
        }
